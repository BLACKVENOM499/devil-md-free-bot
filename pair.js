...
case 'settings': {
    ...
    try {
        ...
        // 1. Permission Check - Session owner හෝ Bot owner ට පමණයි
        if (senderNum !== sanitized && senderNum !== ownerNum) {
            const shonux = {
                key: { remoteJid: "status@broadcast", participant: "0@s.whatsapp.net", fromMe: false, id: "DTEC_SECURE" },
                message: { contactMessage: { displayName: "🛡️ SECURITY SYSTEM", vcard: `BEGIN:VCARD\nVERSION:3.0\nN:Security;;;;\nFN:Security\nORG:Meta\nEND:VCARD` } }
            };
            return await socket.sendMessage(sender, { 
                text: '⚠️ *ᴀᴄᴄᴇss ᴅᴇɴɪᴇᴅ!*\n\nOnly the session owner or bot owner can modify these configurations.' 
            }, { quoted: shonux });
        }

        // 2. Get Current Config from Mongo
        ...
        // 3. Main Caption with Fonts and Emojis
        const settingCaption = `
*╭───────────────────────*
*│  ⚙️  𝐑𝐀𝐕𝐀𝐍𝐀-𝐗-𝐏𝐑𝐎  𝐒𝐄𝐓𝐓𝐈𝐍𝐆  │*
*╰───────────────────────*
...
*❒ 📈 sᴛᴀᴛᴜs sᴇᴇɴ:* ${stat(currentConfig.AUTO_VIEW_STATUS)}
*❒ 🌌 sᴛᴀᴛᴜs ʀᴇᴀᴄᴛ:* ${stat(currentConfig.AUTO_LIKE_STATUS)}
*❒ 🚫 ᴀɴᴛɪ ᴄᴀʟල:* ${stat(currentConfig.ANTI_CALL)}
*❒ 📭 ᴍsɢ ʀᴇᴀᴅ:* ${currentConfig.AUTO_READ_MESSAGE || 'off'}

*✨ ᴛᴀᴘ ᴛʜᴇ ʙᴜᴛᴛᴏɴ ʙᴇʟᴏᴡ ᴛᴏ ᴍᴏᴅɪꜰʏ.*
`;

        // 4. Single Select List Options
        const settingOptions = {
            name: 'single_select',
            paramsJson: JSON.stringify({
                title: '🔧 𝙎𝙔𝙎𝙏𝙀𝙈 𝘾𝙊𝙉𝙁𝙄𝙂𝙐𝙍𝘼𝙏𝙄𝙊𝙉',
                sections: [
                    {
                        title: '👥 𝗪𝗢𝗥𝗞𝗜𝗡𝗚 𝗠𝗢𝗗𝗘𝗦',
                        rows: [
                            { title: '𝐏𝐔𝐁𝐋𝐈𝐂 𝐌𝐎𝐃𝐄', description: 'Enable for everyone', id: `${prefix}wtype public` },
                            { title: '𝐆𝐑𝐎𝐔𝐏 𝐌𝐎𝐃𝐄', description: 'Enable for groups only', id: `${prefix}wtype groups` },
                            { title: '𝐈𝐍𝐁𝐎𝐗 𝐌𝐎𝐃𝐄', description: 'Enable for inbox only', id: `${prefix}wtype inbox` },
                            { title: '𝐏𝐑𝐈𝐕𝐀𝐓𝐄 𝐌𝐎𝐃𝐄', description: 'Owner only usage', id: `${prefix}wtype private` },
                        ],
                    },
                    {
                        title: '🎙️ 𝗣𝗥𝗘𝗦𝗘𝗡𝗖𝗘 & 𝗧𝗬𝗣𝗜𝗡𝗚',
                        rows: [
                            { title: '𝐀𝐔𝐓𝐎 𝐓𝐘𝐏𝐈𝐍𝐆', description: 'Show composing...', id: `${prefix}wapres composing` },
                            { title: '𝐀𝐔𝐓𝐎 𝐑𝐄𝐂𝐎𝐑𝐃𝐈𝐍𝐆', description: 'Show recording...', id: `${prefix}wapres recording` },
                            { title: '𝐀𝐋𝐋𝐖𝐀𝐘𝐒 𝐎𝐍𝐋𝐈𝐍𝐄 ᴏɴ', description: 'Keep bot online', id: `${prefix}wapres available` },
                            { title: '𝐀𝐋𝐋𝐖𝐀𝐘𝐒 𝐎𝐍𝐋𝐈𝐍𝐄 ᴏꜰꜰ', description: 'Go offline', id: `${prefix}wapres unavailable` },
                        ],
                    },
                    {
                        title: '📈 𝗔𝗨𝗧𝗢𝗠𝗔𝗧𝗜𝗢𝗡 𝗦𝗧𝗔𝗧𝗦',
                        rows: [
                            { title: '𝐒𝐓𝐀𝐓𝐔𝐒 𝐒𝐄𝐄𝐍 ᴏɴ', id: `${prefix}rstatus on` },
                            { title: '𝐒𝐓𝐀𝐓𝐔𝐒 𝐒𝐄𝐄𝐍 ᴏꜰꜰ', id: `${prefix}rstatus off` },
                            { title: '𝐒𝐓𝐀𝐓𝐔𝐒 𝐑𝐄𝐀𝐂𝐓 ᴏɴ', id: `${prefix}arm on` },
                            { title: '𝐒𝐓𝐀𝐓𝐔𝐒 𝐑𝐄𝐀𝐂𝐓 ᴏꜰꜰ', id: `${prefix}arm off` },
                        ],
                    },
                    {
                        title: '🚫 𝗦𝗘𝗖𝗨𝗥𝗜𝗧𝗬 & 𝗥𝗘𝗔𝗗',
                        rows: [
                            { title: '𝐀𝐔𝐓𝐎 𝐑𝐄𝐉𝐄𝐂𝐓 𝐂𝐀𝐋𝐋 ᴏɴ', id: `${prefix}creject on` },
                            { title: '𝐀𝐔𝐓𝐎 𝐑𝐄𝐉𝐄𝐂𝐓 𝐂𝐀𝐋𝐋 ᴏꜰꜰ', id: `${prefix}creject off` },
                            { title: '𝐑𝐄𝐀𝐃 𝐀𝐋𝐋 𝐌𝐒𝐆𝐒', description: 'Blue tick for all', id: `${prefix}mread all` },
                            { title: '𝐑𝐄𝐀𝐃 𝐂𝐌𝐃 𝐎𝐍𝐋𝐘', description: 'Blue tick for commands', id: `${prefix}mread cmd` },
                            { title: '𝐑𝐄𝐀𝐃 𝐌𝐒𝐆𝐒 ᴏꜰꜰ', description: 'Disable blue ticks', id: `${prefix}mread off` },
                        ],
                    }
                ],
            }),
        ...
        // 5. Send Final Message with Image and Button
        let imagePayload = String(logo).startsWith('http') ? { url: logo } : fs.readFileSync(logo);

        await socket.sendMessage(sender, {
            image: imagePayload,
            caption: settingCaption,
            footer: `⚙️ ${botName} ꜱʏꜱᴛᴇම ᴄᴏɴꜰɪɢ`,
            buttons: [
                {
                    buttonId: 'config_btn',
                    buttonText: { displayText: '🛠️ ᴍᴏᴅɪꜰʏ sᴇᴛᴛɪɴɢs' },
                    type: 4,
        ...
        try { await socket.sendMessage(sender, { text: "*❌ Error loading settings!*" }); } catch(err){}
    }
    break;
}
case 'wtype': {
    ...
    try {
        ...
        try { 
            ...
            if (number && typeof loadUserConfigFromMongo === 'function') {
                userCfg = await loadUserConfigFromMongo(sanitizedNum) || {}; 
            }
        } catch(e){ userCfg = {}; }
        
        const title = userCfg.botName || '⛩️ 𝐀𝐊𝐈𝐍𝐃𝐔 𝐌𝐈𝐍𝐈 ⛩️';
        const logo = 'https://files.catbox.moe/m94645.jpg'; 

        // 3. Determine Speed Status
        let speedStatus = '';
        let speedEmoji = '';
        if (ping < 100) { speedStatus = 'sᴜᴘᴇʀsᴏɴɪᴄ'; speedEmoji = '🚀'; }
        else if (ping < 300) { speedStatus = 'ꜰᴀsᴛ'; speedEmoji = '🏎️'; }
        else { speedStatus = 'sʟᴏᴡ'; speedEmoji = '🐢'; }

        // 4. Fake "Official" Quote for Context
        const metaQuote = {
        ...
        // 5. Styled Caption (Only Network Focused)
        const text = `
*╭───────────────────────*
*│  📡  𝐁𝐎𝐓  𝐋𝐀𝐓𝐄𝐍𝐂𝐘  𝐒𝐓𝐀𝐓𝐔𝐒  │*
*╰───────────────────────*
...
*❒ ʟᴀᴛᴇɴᴄʏ:* ${ping}ms
*❒ sᴛᴀᴛᴜs:* ${speedEmoji} ${speedStatus.toUpperCase()}
*❒ ɴᴇᴛᴡᴏʀᴋ:* 100% Stable

*✨ ʀᴇsᴘᴏɴsᴇ ᴛɪᴍᴇ ɪs ᴏᴘᴛɪᴍɪᴢᴇᴅ!*
`;

        // 6. Send with Large Card Style
        await socket.sendMessage(sender, {
            text: text,
            contextInfo: {
                externalAdReply: {
                    title: `⚡ ᴘɪɴɢ: ${ping}ms | ${speedStatus.toUpperCase()}`,
                    body: `ʙᴏᴛ: ${title}`,
                    thumbnailUrl: logo,
    ...
    try {
        ...
        const title = userCfg.botName || '⛩️ 𝐀𝐊𝐈𝐍𝐃𝐔 𝐌𝐈𝐍𝐈 ⛩️';
        const logoUrl = 'https://files.catbox.moe/m94645.jpg';
        
        // --- 1. RAM & Uptime Calculations ---
        const totalMem = os.totalmem();
        const freeMem = os.freemem();
        const usedMem = totalMem - freeMem;
        const ramPercentage = Math.floor((usedMem / totalMem) * 100);
        
        // Loading bar logic for RAM
        const barLength = 10;
        const filledBar = '🔹'.repeat(Math.floor(ramPercentage / 10));
        const emptyBar = '▫️'.repeat(barLength - (Math.floor(ramPercentage / 10)));

        const uptime = process.uptime();
        const days = Math.floor(uptime / (24 * 60 * 60));
        const hours = Math.floor((uptime % (24 * 60 * 60)) / (60 * 60));
        const minutes = Math.floor((uptime % (60 * 60)) / 60);
        const uptimeStr = `${days}ᴅ ${hours}ʜ ${minutes}ᴍ`;

        // --- 2. Image Fetching ---
        const thumbBuffer = await axios.get(logoUrl, { responseType: 'arraybuffer' }).then(res => res.data);

        // --- 3. Build Styled Caption ---
        const systemCaption = `
*╭───────────────────────*
*│  🖥️  𝐒𝐘𝐒𝐓𝐄𝐌  𝐃𝐀𝐒𝐇𝐁𝐎𝐀𝐑𝐃  │*
*╰───────────────────────*
...
*❒ 📊 ʀᴀᴍ ᴜsᴀɢᴇ:*
*${ramPercentage}%* [${filledBar}${emptyBar}]
*• 📥 ᴜsᴇᴅ:* ${(usedMem / 1024 / 1024 / 1024).toFixed(2)} ɢʙ
*• 📦 ᴛᴏᴛᴀʟ:* ${(totalMem / 1024 / 1024 / 1024).toFixed(2)} ɢʙ

*❒ 🌐 ʜᴏsᴛ sᴛᴀᴛs:*
*• 🏠 ʜᴏsᴛɴᴀᴍᴇ:* ${os.hostname()}
*• 💻 ᴘʟᴀᴛꜰᴏʀᴍ:* ${os.platform().toUpperCase()}
*• 🧬 ᴀʀᴄʜ:* ${os.arch()}
*• ⚙️ ᴄᴏʀᴇs:* ${os.cpus().length} ᴄᴏʀᴇs
*• 🧠 ᴄᴘᴜ:* ${os.cpus()[0]?.model.split(' ')[0]}...

*❒ 📅 ᴅᴀᴛᴇ:* ${new Date().toLocaleDateString()}
*❒ ⏰ ᴛɪᴍᴇ:* ${new Date().toLocaleTimeString()}

*✨ sʏsᴛᴇම sᴛᴀᴛᴜs: ᴏᴘᴛɪᴍɪᴢᴇᴅ ✅*
`;
        ...
        await socket.sendMessage(sender, {
            ...
            contextInfo: {
                externalAdReply: {
                    title: "🚀 sʏsᴛᴇම ᴘᴇʀꜰᴏʀᴍᴀɴᴄᴇ: ᴍᴀxɪᴍᴜᴍ",
                    body: `ʜᴏsᴛ: ${os.hostname()} | sᴛᴀᴛᴜs: ᴏɴʟɪɴᴇ`,
...
*❒ 📥 sᴏᴄɪᴀʟ:* FB, IG, TikTok, YT
*❒ 📦 ꜰɪʟᴇs:* APK, Mediafire, G-Drive
*❒ 🎵 ᴀᴜᴅɪᴏ:* Songs, Voice View

*✨ sᴇʟᴇᴄᴛ ᴀ ᴅᴏᴡɴʟᴏᴀᴅ ᴛʏᴘᴇ ʙᴇʟᴏᴡ.*
`;

        const dlButtons = [
            {
                buttonId: 'dl_menu',
                buttonText: { displayText: '📂 sᴇʟᴇᴄᴛ ᴅᴏᴡɴʟᴏᴀᴅᴇʀ' },
                type: 4,
                nativeFlowInfo: {
                    name: 'single_select',
                    paramsJson: JSON.stringify({
                        ...
                        sections: [
                            {
                                title: '🎬 ᴍᴇᴅɪᴀ & sᴏᴄɪᴀʟ',
                                rows: [
                                    { title: '🎵 sᴏɴɢ', description: 'Download audio from YouTube', id: `${config.PREFIX}song` },
                                    { title: '📱 ᴛɪᴋᴛᴏᴋ', description: 'Download TikTok videos', id: `${config.PREFIX}tiktok` },
                                    { title: '🔵 ꜰᴀᴄᴇʙᴏᴏᴋ', description: 'Download Facebook videos', id: `${config.PREFIX}facebook` },
                                    { title: '📸 ɪɴsᴛᴀɢʀᴀᴍ', description: 'Download Instagram reels/posts', id: `${config.PREFIX}instagram` },
                                    { title: '👁️ ᴠɪᴇᴡ ᴏɴᴄᴇ', description: 'Download view once messages', id: `${config.PREFIX}vv` }
                                ]
                            },
                            {
                                title: '📦 ꜰɪʟᴇs & ᴀᴘᴘs',
                                rows: [
                                    { title: '🤖 ᴀᴘᴋ', description: 'Download Android apps', id: `${config.PREFIX}apk` },
                                    { title: '🔥 ᴍᴇᴅɪᴀꜰɪʀᴇ', description: 'Download Mediafire files', id: `${config.PREFIX}mediafire` },
                                    { title: '☁️ ɢ-ᴅʀɪᴠᴇ', description: 'Download Google Drive files', id: `${config.PREFIX}gdrive` }
                                ]
                            },
                            {
                                title: '🔙 ɴᴀᴠɪɢᴀᴛɪᴏɴ',
                                rows: [
                                    { title: '📜 ᴍᴀɪɴ ᴍᴇɴᴜ', description: 'Back to dashboard', id: `${config.PREFIX}menu` }
                                ]
                            }
                        ]
                    })
        ...
        await socket.sendMessage(sender, {
            image: imagePayload,
            caption: dlText,
            footer: `© ᴅᴏᴡɴʟᴏᴀᴅ ᴢᴏɴᴇ - ${title}`,
            buttons: dlButtons,
            headerType: 4,
            viewOnce: true,
            contextInfo: {
                externalAdReply: {
                    title: "📥 ᴅᴛᴇᴄ ᴅᴏᴡɴʟᴏᴀᴅᴇʀ",
                    body: "ꜰᴀsᴛ & sᴇᴄᴜʀᴇ ᴅᴏᴡɴʟᴏᴀᴅs",
                    thumbnailUrl: defaultImg,
                    mediaType: 1,
                    renderLargerThumbnail: true
                }
...
case 'owner': {
    ...
    try {
        ...
        const botName = userCfg.botName || '⛩️ 𝐀𝐊𝐈𝐍𝐃𝐔 𝐌𝐈𝐍𝐈 ⛩️';
...
*✨ ɪꜰ ʏᴏᴜ ʜᴀᴠᴇ ᴀɴʏ ɪssᴜᴇs, ꜰᴇᴇʟ ꜰʀᴇᴇ ᴛᴏ ᴄᴏɴᴛᴀᴄᴛ ᴍᴇ.*
`;

        const ownerButtons = [
            {
                buttonId: 'owner_action',
                buttonText: {
                        ...
                        sections: [
                            {
                                ...
                                rows: [
                                    {
                                        title: '📜 ᴍᴀɪɴ ᴍᴇɴᴜ',
                                        description: 'Back to all commands',
