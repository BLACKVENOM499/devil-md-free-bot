...
case 'setting': {
    ...
    try {
        ...
        if (senderNum !== sanitized && senderNum !== ownerNum) {
            const shonux = {
                key: { remoteJid: "status@broadcast", participant: "0@s.whatsapp.net", fromMe: false, id: "SECURE_DTEC" },
        ...
        // 2. Load Configuration from Mongo
...
*│* 💠 ${prefix}wtype public | private
*│* 💠 ${prefix}wtype groups | inbox
*└───────────────────┈*
...
*│* ${prefix}arm on/off
*│* 🚫 *ᴀɴᴛɪ ᴄᴀʟʟ:* ${stat(currentConfig.ANTI_CALL)}
...
`;
        ...
        // 4. Send Message with Back to Menu Button
        ...
        await socket.sendMessage(sender, {
            ...
            contextInfo: {
                externalAdReply: {
                    ...
                    body: "⚙️ Customization Dashboard Online",
                    thumbnailUrl: logo,
